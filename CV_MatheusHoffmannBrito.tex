...
\textbf{Frameworks/Libraries}{: Scikit-learn, TensorFlow, Keras, Numpy, Pandas, Matplotlib, Seaborn, Plotly, SimpleITK.} \\
...
\textbf{Certifications}{: Machine Learning Analyst (IGTI-Bootcamp, 2021), SQL (Softblue, 2022), Intro to SQL (Kaggle, 2021), Natural Language Processing (Kaggle, 2021), Data Cleaning (Kaggle, 2021), Data Visualization (Kaggle, 2021), Google Analytics for beginners (Google Analytics, 2021), Certificate DELE (Diplomas de Español como Lengua Extranjera) level B2, Microsoft Excel 2010 (PUC-Rio, 2014).}
}}
\end{itemize}
\vspace{-16pt}
...
\resumeSubheading
{\href{https://www.ctis.com.br}{CTIS | SONDA Group}}{Oct. 2021 -- Present}
...
\resumeItem{Planning and running simulations in a High-Performance Computing (HPC) environment.}
\resumeItemListEnd
...
{\textbf{\href{https://github.com/matheus-hoffmann/SklTest}{Skl Test}} $|$ \emph{Python, Scikit-learn}}{Jul. 2021}
\resumeItemListStart
\resumeItem{Developed a python library to compare the performance obtained by models available in Scikit-learn to solve regression and classification problems. It is possible to evaluate the influence of successive resampling and optimize the hyperparameters through a K-fold cross-validation holdout.}
\resumeItemListEnd

\resumeProjectHeading
{\textbf{\href{https://github.com/matheus-hoffmann/BajaCompetitions}{Baja Competitions}} $|$ \emph{Python, Scikit-learn, Flask, Heroku}}{Apr. 2022}
\resumeItemListStart
\resumeItem{Exploratory analysis of the results of Baja SAE teams in National competitions and development of an API to provide the cloud service at Heroku.}
\resumeItemListEnd
